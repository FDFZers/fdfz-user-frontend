import { LucideArrowRight, LucideCheck, LucideInfo, LucideUndo2 } from "lucide-react";
...
function getPasswordError(value: string): string | null {
  if (value && !PASSWORD_RE.test(value)) return "密码需为 8-64 位，且同时包含大小写字母和数字";
  return null;
}
    ...
    <>
      ...
      <div className="signup-page flex min-h-screen w-full max-w-[460px] flex-col justify-center px-6 pt-12 pb-16 mx-auto max-[380px]:px-4 max-[380px]:py-4 animate-[signup-page-in_0.45s_var(--ease-out)_both]">
            ...
            <>
                ...
                <div className="signup-info">
                  ...
                  >
                    <div className="signup-step flex flex-col gap-5" key="1">
                      ...
                      {usernameError && (
                        <p className="signup-field-error -mt-3 text-[13px] text-[var(--danger)]">
                          {usernameError}
                        </p>
                      )}
                ...
                <div className="signup-info">
                  ...
                  >
                    <div className="signup-step flex flex-col gap-5" key="3">
                      ...
                      {passwordMismatch && (
                        <p className="signup-password-mismatch -mt-2 text-[13px] text-[var(--danger)]">
                          两次输入的密码不一致
                        </p>
                      )}
              ...
              {step === 4 && (
                <div className="signup-auth">
                  ...
                  <h1 className="m-0 mb-5 text-lg font-semibold text-center text-[var(--foreground)]">
                    我们需要验证您确实是复旦附中的学生。
                  </h1>
                  ...
                  <Form className="signup-auth-form flex flex-col gap-5" onSubmit={handleSubmit}>
                    <div className="signup-step flex flex-col gap-5" key="5">
                        ...
                        <div className="signup-authfile-row flex items-center gap-2">
                          ...
                          <Tooltip delay={0}>
                            ...
                            <Tooltip.Content showArrow className="signup-authfile-tooltip max-w-64">
                              ...
                              <p>
                                浦东分校 <strong>+20</strong>，如 20292101
                              </p>
                              <p>
                                青浦分校 <strong>+40</strong>，如 20294101
                              </p>
                              <p>
                                徐汇分校 <strong>+60</strong>，如 20296101
                              </p>
                              <p>静安分校请先用 12 班班级号</p>
                            </Tooltip.Content>
                          </Tooltip>
                      ...
                      <div className="signup-authfile-field flex flex-col gap-2">
                        ...
                        {materialError && (
                          <p className="signup-field-error text-[13px] text-[var(--danger)]">
                            {materialError}
                          </p>
                        )}
                      </div>
        ...
        <p className="signup-page__footer mt-5 text-center text-sm text-[color-mix(in_srgb,var(--foreground)_60%,transparent)]">
          已有账号？
          <Link className="signup-page__link text-[var(--accent)] no-underline" to="/login">
            去登录
          </Link>
        </p>
      </div>
